...
STUB(dsSetFPDMode)
STUB(dsSetFPBlink)
STUB(dsFPEnableCLockDisplay)
STUB(dsFPGetLEDState)
STUB(dsFPGetSupportedLEDStates)
STUB(dsFPSetLEDState)
STUB(dsGetFPState)
STUB(dsGetFPTextBrightness)
STUB(dsGetFPTimeFormat)
STUB(dsSetFPScroll)
STUB(dsSetFPState)
STUB(dsSetFPText)
STUB(dsSetFPTextBrightness)
STUB(dsSetFPTime)
STUB(dsSetFPTimeFormat)
int dsFPDColor_isValid() { return 1; }

STUB(dsHostInit)
STUB(dsHostTerm)
STUB(dsGetHostEDID)
STUB(dsGetCPUTemperature)
STUB(dsGetSocIDFromSDK)
...
STUB(dsEnableMS12Config)
STUB(dsAudioPortInit)
STUB(dsAudioPortTerm)
STUB(dsGetAudioPort)
STUB(dsGetApplicationAudioConfig)
STUB(dsGetApplicationAudioConfigList)
...
STUB(dsSetApplicationAudioConfig)
STUB(dsSetAudioMixerLevels)
